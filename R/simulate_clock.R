...
clock_simulate <- function(alphs_oi,
                           metaData,
                           region_metaData,
                           perc_meth,
                           region_metaData_te,
  ...
  for (alph in alphs_oi){
    ...
    if (alph == alphs_oi[1]){
      all_res_metaData <- rbind(list_res[['metaData']], list_res_TE[['metaData']],list_res_PR[['metaData']], list_res_CpGIs[['metaData']],list_res_rand[['metaData']])
      all_res_region_metaData <- rbind(list_res[['region_metaData']], list_res_TE[['region_metaData']],list_res_PR[['region_metaData']], list_res_CpGIs[['region_metaData']],list_res_rand[['region_metaData']])
      all_res_clock <- rbind(list_res[['clock_results']], list_res_TE[['clock_results']],list_res_PR[['clock_results']], list_res_CpGIs[['clock_results']],list_res_rand[['clock_results']])
    }else{
      all_res_metaData<- rbind(all_res_metaData, list_res[['metaData']], list_res_TE[['metaData']],list_res_PR[['metaData']], list_res_CpGIs[['metaData']],list_res_rand[['metaData']])
      all_res_region_metaData<- rbind(all_res_region_metaData, list_res[['region_metaData']], list_res_TE[['region_metaData']],list_res_PR[['region_metaData']], list_res_CpGIs[['region_metaData']],list_res_rand[['region_metaData']])
      all_res_clock<- rbind(all_res_clock, list_res[['clock_results']], list_res_TE[['clock_results']],list_res_PR[['clock_results']], list_res_CpGIs[['clock_results']],list_res_rand[['clock_results']])
    }
  }

  all_res_list <- list()
  all_res_list[["metaData"]] <- all_res_metaData
  all_res_list[["region_metaData"]] <- all_res_region_metaData
  all_res_list[["clock_results"]] <- all_res_clock
